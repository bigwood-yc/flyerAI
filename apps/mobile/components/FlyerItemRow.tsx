...
export default function FlyerItemRow({ item }: Props) {
  ...
  return (
    <View className="bg-white border border-gray-200 rounded-lg px-4 py-3 mb-2 flex-row items-center gap-3">
      <Text className="text-2xl w-8 text-center" accessibilityElementsHidden>
        {item.emoji}
      </Text>
